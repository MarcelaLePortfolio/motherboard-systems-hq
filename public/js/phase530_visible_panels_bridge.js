(function () {
  ...
  function phase719EnsurePreviewModal() {
    ...
    modal.style.cssText = "display:none;position:fixed;inset:0;z-index:9999;background:rgba(2,6,23,.72);backdrop-filter:blur(5px);align-items:center;justify-content:center;padding:18px;overflow:hidden;";

    modal.innerHTML = `

      <div role="dialog" aria-modal="true" aria-labelledby="phase719-preview-title" style="width:min(880px,96vw);height:min(820px,88vh);max-height:88vh;display:flex;flex-direction:column;overflow:hidden;background:#020617;border:1px solid rgba(148,163,184,.35);border-radius:16px;box-shadow:0 24px 70px rgba(0,0,0,.55);padding:16px;color:#e5e7eb;">
  ...
  function phase719RenderArtifactIframePreview(renderedHtml) {
    ...
    return `
      ...
      <iframe
        ...
        style="display:block;width:100%;height:min(650px,70vh);min-height:420px;border:1px solid rgba(148,163,184,.24);border-radius:16px;background:#020617;"
  ...
  async function phase719OpenPreviewModal(button) {
    ...
    body.innerHTML = `<div style="color:#93c5fd;font-size:14px;border:1px solid rgba(147,197,253,.24);background:rgba(30,64,175,.12);border-radius:12px;padding:14px;">Loading rendered artifact preview…</div>`;
