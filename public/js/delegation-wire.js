...
(function () {
console.log("[delegation-wire] script loaded");
...
if (!input) {
  console.warn("[delegation-wire] delegation input not found at click time");
  return;
}
...
```
if (!btn || !input) {
  console.warn("[delegation-wire] delegation button or input not found in init");
  return;
}
