...
const registerAgent = registryModule.registerAgent ??
...
const matildaModule = require(path.resolve(process.cwd(), "agents/matilda.ts/matilda.mjs"));
const matilda = matildaModule.matilda ??
