...
function appendReflection(p, line) {
    let rows = [];
    try {
...
function writeStatus(p, label, seq, idx) {
...
function writeTemplateSet(stagingDir, name, kind) {
...
async function progressiveReveal(stagingDir, targetDir, paceMs) {
    ensureDir(targetDir);
...
function registerEntity(name, kind) {
    try {
