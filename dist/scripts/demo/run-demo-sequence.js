...
export async function runDemoSequence() {
    ...
    try {
        ...
        reflections.forEach(r => sqlite.prepare("INSERT INTO reflection_index (content) VALUES (?)").run(r));
        const tasks = [
        ...
        tasks.forEach(t => sqlite.prepare("INSERT INTO task_events (description, status) VALUES (?, 'completed')").run(t));
