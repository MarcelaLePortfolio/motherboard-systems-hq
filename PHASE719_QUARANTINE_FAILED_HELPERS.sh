...
echo "===== PHASE 719: QUARANTINE FAILED HELPERS ====="

mkdir -p checkpoints/phase719_quarantined_failed_helpers

BRANCH="$(git branch --show-current)"

OUT="checkpoints/PHASE719_QUARANTINE_FAILED_HELPERS.txt"
...
git add PHASE719_QUARANTINE_FAILED_HELPERS.sh
...
echo "===== FAILED HELPERS QUARANTINED ====="
