...
* [ ] Docker / dev server for the dashboard is running (containerized dashboard on [http://127.0.0.1:8080/dashboard](http://127.0.0.1:8080/dashboard) or your current dev URL)
...
* [ ] URL loads: [http://127.0.0.1:8080/dashboard](http://127.0.0.1:8080/dashboard)
...
1. Type a short message into the chat input (e.g., "ping from dashboard").
2. Click the send button (or equivalent trigger).
