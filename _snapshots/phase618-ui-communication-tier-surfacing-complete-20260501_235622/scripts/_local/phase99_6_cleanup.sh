...
rm -f \
  scripts/_local/phase99_6_locate_guidance_priority_surface.sh \
  scripts/_local/phase99_6_mapping_surface_inspect.sh \
  scripts/_local/phase99_6_reducer_restore.sh

cat > src/cognition/operatorGuidanceReducer.ts << 'TS'
/*
...
git add -A
git commit -m "phase99.6: revert speculative reducer weighting attempt and clean helper scripts"
git push
bash scripts/_local/phase99_4_status_check.sh
