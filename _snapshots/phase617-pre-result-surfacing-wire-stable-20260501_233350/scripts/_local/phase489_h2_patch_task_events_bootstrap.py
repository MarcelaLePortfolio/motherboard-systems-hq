...
import_line = 'import { ensureTaskEventsTable } from "./server/db_bootstrap_task_events_table.mjs";\n'
...
call_line = "await ensureTaskEventsTable(pool);\n"
...
print("Patched server.mjs to bootstrap task_events table")
