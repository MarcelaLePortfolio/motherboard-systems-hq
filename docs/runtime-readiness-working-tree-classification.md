...
# Runtime Readiness Working Tree Classification

Status: DRAFT CLASSIFICATION

Checkpoint: 640a84fe

## Purpose

Classify dirty working tree entries before deciding whether to ignore, preserve, commit, restore, or manually review them.

## Rule

No cleanup action is authorized by this file.
...
?? docs/runtime-readiness-working-tree-classification.md
...
Likely manual-review candidates:

- package-lock.json

- dashboard-script-style-boundary-map.txt

- root-level inspection reports

- root-level recovery scripts
...
- governance and interpretation inspection artifacts

## Next decision

Review whether the likely local/generated files should be added to .gitignore, and whether any manual-review files represent intentional source or documentation work.
