...
# Runtime Readiness Working Tree Triage Inventory
...
Capture the current dirty working tree state before any cleanup, ignore-rule changes, or runtime planning proceeds.

## Boundary

This inventory does not approve deletion, restoration, or commitment of unrelated files.

It only preserves evidence for review.
...
?? docs/runtime-readiness-working-tree-triage-inventory.md
...
Runtime Package Behavior planning remains blocked until this triage is complete.
