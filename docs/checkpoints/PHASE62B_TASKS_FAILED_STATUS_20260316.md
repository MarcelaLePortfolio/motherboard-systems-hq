...
Record a clean handoff for Tasks Failed and preserve the corridor as controlled before selecting any further metric.
...
Tasks Failed status is recorded truthfully:
implemented,
locally verified,
