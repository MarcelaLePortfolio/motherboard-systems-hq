...
const cognitiveCohesion = require("./routes/diagnostics/cognitiveCohesion.js");
const insightVisualizer = require("./routes/diagnostics/insightVisualizer.js");
...
const systemHealth = require("./routes/diagnostics/systemHealth.js");
const persistentInsight = require("./routes/diagnostics/persistentInsight.js");
const cognitiveCohesion = require("./routes/diagnostics/cognitiveCohesion.js");
const introspectiveSim = require("./routes/diagnostics/introspectiveSim.js");
const autonomicAdaptation = require("./routes/diagnostics/autonomicAdaptation.js");
const cognitiveCohesion = require("./routes/diagnostics/cognitiveCohesion.js");
const insightVisualizer = require("./routes/diagnostics/insightVisualizer.js");
app.use("/diagnostics/cognitive-cohesion", cognitiveCohesion);
app.use("/diagnostics/insight-visualizer", insightVisualizer);
...
app.use("/diagnostics/cognitive-cohesion", cognitiveCohesion);
app.use("/diagnostics/insight-visualizer", insightVisualizer);
const systemChronicle = require("./routes/diagnostics/systemChronicle.js");
const insightVisualizer = require("./routes/diagnostics/insightVisualizer.js");
app.use("/diagnostics/system-health", systemHealth);
app.use("/diagnostics/persistent-insight", persistentInsight);
app.use("/diagnostics/cognitive-cohesion", cognitiveCohesion);
