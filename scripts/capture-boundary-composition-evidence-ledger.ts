...
async function capture(
  ...
  const sourceTurnId =
    `turn-boundary-evidence-ledger-${index + 1}`;
...
async function main(): Promise<void> {
  console.log(
    "=== BOUNDARY COMPOSITION EVIDENCE LEDGER ===",
  );
  console.log(
    "CLASSIFICATION: BOUNDARY_COMPOSITION_EVIDENCE_LEDGER_VALIDATION_READY",
  );
  console.log(
  ...
  console.log();
  console.log(
    "BOUNDARY_COMPOSITION_EVIDENCE_LEDGER_CAPTURE_COMPLETE",
  );
  console.log(
