      ...
      `${OLLAMA_BASE_URL}/api/generate`,
      {
        ...
        body: JSON.stringify({
          ...
          prompt: [
            ...
            "Use Reasoning Status: Recommended only when skipping the supporting reasoning is likely to materially change the user's next engineering decision because of architectural nuance, implementation boundaries, significant uncertainty, competing interpretations, or evidence whose interpretation affects the conclusion.",
