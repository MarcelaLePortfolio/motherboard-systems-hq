      ...
      `${OLLAMA_BASE_URL}/api/generate`,
      {
        ...
        body: JSON.stringify({
          ...
          prompt: [
            ...
            "Ground the explanation only in evidence, constraints, tradeoffs, implementation boundaries, and material uncertainty explicitly present in the supplied conversation history or retrieved project context.",
            "Never invent supporting evidence, architectural properties, implementation characteristics, scalability claims, performance claims, maintenance claims, tradeoffs, or test results that are not explicitly established by the supplied context.",
            "If the supplied context is insufficient to justify the previous conclusion, explicitly say that the available context is insufficient for a reliable engineering explanation instead of filling the gap with plausible details.",
