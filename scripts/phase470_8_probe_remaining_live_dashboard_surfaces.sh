...

{
  ...
  echo "EventSource count: $(rg -o 'new EventSource' "$BUNDLE" | wc -l | tr -d ' ')"
  echo "setInterval count: $(rg -o 'setInterval\\(' "$BUNDLE" | wc -l | tr -d ' ')"
  echo "setTimeout count: $(rg -o 'setTimeout\\(' "$BUNDLE" | wc -l | tr -d ' ')"
  echo "fetch count: $(rg -o 'fetch\\(' "$BUNDLE" | wc -l | tr -d ' ')"
  echo
