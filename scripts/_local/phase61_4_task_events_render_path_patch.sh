...
TARGET_JS="public/js/task-events-sse-client.js"
...
if [[ ! -f "$TARGET_JS" ]]; then
  echo "ERROR: missing $TARGET_JS" >&2
  exit 1
fi
...
cp "$TARGET_JS" "${TARGET_JS}.bak.phase61_4"
...
echo "Phase 61.4 task-events render-path patch applied safely."
echo "Backup saved to ${TARGET_JS}.bak.phase61_4"
echo "Next:"
