...
start = text.find("    function buildOwnedShell(key) {")
end = text.find("    function renderEmpty(listEl, message) {")
if start == -1 or end == -1 or end <= start:
    raise SystemExit("could not locate buildOwnedShell/ensureOwnedCard block")
