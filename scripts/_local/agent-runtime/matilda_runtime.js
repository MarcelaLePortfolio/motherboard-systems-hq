...
function setStatus(status) {
  ...
  data.matilda = { status, lastHeartbeat: Math.floor(Date.now()/1000) };
...
function shutdown() {
  logEvent('matilda', '❌ Matilda offline');
  setStatus('offline');
  process.exit();
}
...
console.log("🤖 Matilda Runtime Started — Orchestration placeholder");
