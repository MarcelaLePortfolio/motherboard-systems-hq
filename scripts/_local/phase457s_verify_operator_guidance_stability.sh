...
OUT="docs/recovery_full_audit/68_verify_operator_guidance_stability.txt"
mkdir -p "$(dirname "$OUT")"
...
{
  echo "PHASE 457S — OPERATOR GUIDANCE STABILITY VERIFICATION"
  echo "====================================================="
  echo
