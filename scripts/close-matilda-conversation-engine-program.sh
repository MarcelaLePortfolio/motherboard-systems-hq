...
NON_RUNTIME_SUCCESSOR_PRIORITY=NONE_ESTABLISHED
PRODUCTION_CHANGE=NONE
PROGRAM_CLOSURE=COMPLETE_BOUNDED
DR_NOW=YES
NEXT_ACTION=COMMIT_FORMAL_PROGRAM_CLOSURE_AND_RUN_SINGLE_CANONICAL_PROGRAM_CLOSURE_DR
MAP
