...
OUTPUT_FILE="PHASE88_14_5_SYSTEM_HEALTH_MOUNT_VERIFICATION.txt"
BOOT_LOG="PHASE88_14_5_SERVER_RESTART.log"
PID_FILE=".phase88_14_5_server.pid"
BASE_URL="${1:-http://127.0.0.1:3000}"

PRIMARY_JSON="PHASE88_14_5_SYSTEM_HEALTH_RESPONSE.json"
ALIAS_JSON="PHASE88_14_5_SYSTEM_HEALTH_ALIAS_RESPONSE.json"
...
primary = json.loads(Path("PHASE88_14_5_SYSTEM_HEALTH_RESPONSE.json").read_text())
alias = json.loads(Path("PHASE88_14_5_SYSTEM_HEALTH_ALIAS_RESPONSE.json").read_text())
...
{
  echo "PHASE 88.14.5 SYSTEM HEALTH MOUNT VERIFICATION"
