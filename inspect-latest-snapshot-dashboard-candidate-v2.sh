...
REPORT="LATEST_SNAPSHOT_DASHBOARD_CANDIDATE_INSPECTION_V2.txt"

cat > inspect-latest-snapshot-dashboard-candidate-v2.py << 'PY'
...
python3 inspect-latest-snapshot-dashboard-candidate-v2.py

git add inspect-latest-snapshot-dashboard-candidate-v2.sh inspect-latest-snapshot-dashboard-candidate-v2.py LATEST_SNAPSHOT_DASHBOARD_CANDIDATE_INSPECTION_V2.txt _dashboard_candidate_previews/latest-snapshot || true

git commit -m "Inspect latest snapshot dashboard candidate v2" || true
